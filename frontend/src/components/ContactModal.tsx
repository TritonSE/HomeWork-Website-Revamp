...
//                 className={`relative inline-flex items-center justify-center bg-transparent border-2 border-transparent cursor-pointer transition-border-color duration-300 ease-in-out w-[82px] h-11 rounded-lg border-width-[1px] ${status === "error" ? "border-gray-300 shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)]" : ""} p-2`}
//               >
...
//           {showMessage && (
//             <div
//               className={`form-result ${formResult.success ? "bg-green-100 border-green-400 text-green-700" : "bg-red-100 border-red-400 text-red-700"} border-2 rounded-md p-4 mt-2 z-1000`}
//             >
//               {formResult.result}
//             </div>
//           )}
